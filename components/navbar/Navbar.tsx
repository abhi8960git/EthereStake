          ...
          >
            ...
            <Modal.Body>
              <Text id="modal-description">
                ...
                <h3>  2. Stakeholder Participation:</h3>
                ...
                <br />
                ,<h3> 4. Proposal Waiting Period:</h3>
                ...
                <br />
                <h3> 6. Payout for Beneficiary:</h3>
